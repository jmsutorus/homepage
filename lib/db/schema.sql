...
-- Park Photos Table
-- Stores external image URLs for park photo galleries
...
-- Park Trails Table
-- Tracks specific trails hiked at a park
...
-- Stores daily Duolingo lesson completion records (per user)
-- Since Duolingo's API doesn't expose completion data, users manually mark their progress
...
-- ==================== HOLIDAYS ====================
-- Global holidays visible to all users, managed by admins

-- Holidays Table
-- Stores holidays with month/day for recurring annual display
