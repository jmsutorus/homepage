...
export default auth((req) => {
  ...
  const publicPaths = ["/", "/features", "/sign-in", "/sign-up", "/auth/error", "/request-access", "/privacy", "/terms", "/cookies", "/support", "/contact", "/about", "/not-found", "/not-allowed", "/forgot-password"];
