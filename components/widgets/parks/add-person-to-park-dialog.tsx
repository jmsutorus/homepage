...
interface AddPersonToParkDialogProps {
  parkSlug: string;
...
export function AddPersonToParkDialog({
  parkSlug,
  existingPeople,
  open,
  onOpenChange,
  onSuccess,
}: AddPersonToParkDialogProps) {
  ...
  // Filter out people already added to park
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Select a person to add to this park visit.
          </DialogDescription>
        </DialogHeader>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                {availablePeople.length === 0
                  ? 'All people have been added to this park visit!'
