        ...
        <Tabs defaultValue="upload" className="w-full">
          ...
          <TabsContent value="upload" className="space-y-6">
            ...
            >
              {previewUrl ? (
                isNoPreviewFormat ? (
                  <div className="relative w-full aspect-square max-w-[200px] rounded-xl bg-media-surface-container-high flex flex-col items-center justify-center gap-2 border-2 border-dashed border-media-outline-variant/50 text-media-primary p-4 shadow-lg group mx-auto">
