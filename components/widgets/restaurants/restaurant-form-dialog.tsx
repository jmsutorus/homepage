...
export function RestaurantFormDialog({
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="mb-2 text-base h-12 border-2 focus-visible:ring-brand"
        />
  ...
  const buttonText = loading ? 'Saving...' : isEditing ? 'Update' : 'Add Restaurant';
      ...
      >
        <div className="flex flex-col h-full">
          <SheetHeader className="px-6 pt-6 pb-4 border-b text-left">
            <SheetTitle>{isEditing ? 'Edit Restaurant' : 'Add Restaurant'}</SheetTitle>
          </SheetHeader>
